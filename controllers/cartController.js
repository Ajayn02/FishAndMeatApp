...
exports.addToCart = async (req, res) => {
    try {
        ...
        const { productId, title, description, price, image, rating, availability, category } = req.body
        ...
        if (existing) {
            ...
            const cartProduct = await prisma.cart.create({
                data: { productId, quantity: 1, title, description, price, image, rating, availability, category, userId }
            })
